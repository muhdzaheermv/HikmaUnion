...
const artists = [
    ...
    },
    {
        ...
        id: "amittrivedi",
        content: 'Get ready to witness an electrifying performance by the one and only, the renowned Bollywood singer and composer Amit Trivedi at Hikma\'23 - South India\'s  biggest cultural fest! Brace yourselves for an unforgettable evening as Amit Trivedi is all set to set the stage on fire with his scintillating voice and chart-topping hits. So mark your calendars and get ready to groove to his sensational tunes on the 12th of March, as we bring you the biggest musical extravaganza of the year!'
    }
]
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Hikma 2025 | Proshow" />
